...
public class Rucksack2 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Character> lets1 = new ArrayList<>();
        ArrayList<Character> lets2 = new ArrayList<>();
        ...
        while(scr.hasNext()){
            String sack1 = scr.nextLine();
            String sack2 = scr.nextLine();
            String sack3 = scr.nextLine();

            int length = sack1.length() + sack2.length() + sack3.length();

            //loop across the first sack
            for (int i = 0; i < length; i++) {

            }

            //loop across the second sack

            //loop across the third sack
        }
